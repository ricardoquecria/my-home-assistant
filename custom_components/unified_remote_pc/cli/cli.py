...
from custom_components.unified_remote_pc.cli.args import arg_handler
from custom_components.unified_remote_pc.cli.connection import Connection
from custom_components.unified_remote_pc.cli.remotes import Remotes

if __name__ == "__main__":
    # Set remotes.yaml directory location.
    absolute_path = path[0] + "/custom_components/unified_remote_pc/cli/"
